...
var brojDresaInput = document.getElementById("broj_dresa");
...
function dodajPacijenta(e) {
  ...
  var brojDresa = parseInt(brojDresaInput.value);
  ...
  if (
    ...
    showMessage("Unesi ispravne podatke.");
    return;
  }

  var podaci = new FormData(playerForm);
  podaci.append("pozicija", pozicija);
  podaci.append("broj_dresa", brojDresa);
  ...
  zahtev.onload = function () {
    showMessage(zahtev.responseText);
    playerForm.reset();
    prikaziPacijente();
  };
...
function prikaziKarticePacijenata() {
  ...
  switch (nacinSortiranja) {
    ...
    case "godine-asc":
      listaZaPrikaz.sort(function (a, b) {
        return parseInt(a.godine) - parseInt(b.godine);
      });
      break;
    case "godine-desc":
      listaZaPrikaz.sort(function (a, b) {
        return parseInt(b.godine) - parseInt(a.godine);
      });
      break;
    case "rings-asc":
      listaZaPrikaz.sort(function (a, b) {
        return parseInt(a.prstenovi) - parseInt(b.prstenovi);
      });
      break;
    case "rings-desc":
      listaZaPrikaz.sort(function (a, b) {
    ...
    case "dres-asc":
      listaZaPrikaz.sort(function (a, b) {
        return parseInt(a.broj_dresa) - parseInt(b.broj_dresa);
      });
      break;
    case "dres-desc":
      listaZaPrikaz.sort(function (a, b) {
        return parseInt(b.broj_dresa) - parseInt(a.broj_dresa);
      });
      break;
    case "visina-asc":
      listaZaPrikaz.sort(function (a, b) {
        return parseFloat(a.visina) - parseFloat(b.visina);
      });
      break;
    case "visina-desc":
      listaZaPrikaz.sort(function (a, b) {
        return parseFloat(b.visina) - parseFloat(a.visina);
      });
      break;
    case "tezina-asc":
      listaZaPrikaz.sort(function (a, b) {
        return parseFloat(a.tezina) - parseFloat(b.tezina);
      });
      break;
    case "tezina-desc":
      listaZaPrikaz.sort(function (a, b) {
    ...
    case "apg-asc":
      listaZaPrikaz.sort(function (a, b) {
        return parseFloat(a.apg) - parseFloat(b.apg);
      });
      break;
    case "apg-desc":
      listaZaPrikaz.sort(function (a, b) {
        return parseFloat(b.apg) - parseFloat(a.apg);
      });
      break;
    case "rpg-asc":
      listaZaPrikaz.sort(function (a, b) {
        return parseFloat(a.rpg) - parseFloat(b.rpg);
      });
      break;
    case "rpg-desc":
      listaZaPrikaz.sort(function (a, b) {
        return parseFloat(b.rpg) - parseFloat(a.rpg);
      });
      break;
    default:
      // no sorting
  ...
  for (var i = 0; i < listaZaPrikaz.length; i++) {
    ...
    kartica.className = "col-12 col-md-6 col-xl-4";
      ...
      igrac.pozicija +
      "</div>" +
      '<div class="info-line"><strong>Broj dresa:</strong> ' +
      igrac.broj_dresa +
      "</div>" +
...
function otvoriUrediModal(igrac) {
  ...
  document.getElementById("editBrojDresa").value = igrac.broj_dresa || "";
...
function sacuvajIzmene() {
  ...
  var brojDresa = parseInt(document.getElementById("editBrojDresa").value);
